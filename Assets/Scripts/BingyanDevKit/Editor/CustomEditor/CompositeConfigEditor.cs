...
namespace Bingyan.Editor
{
    ...
    {
        private static Dictionary<Type, List<string>> menus = new Dictionary<Type, List<string>>();
        private static Dictionary<Type, Dictionary<string, string>> menuToClassName = new Dictionary<Type, Dictionary<string, string>>();
        private static Dictionary<Type, Dictionary<Type, string>> typeToName = new Dictionary<Type, Dictionary<Type, string>>();
