...
namespace Bingyan
{
    public abstract class RangeDrawerBase : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.LabelField(new Rect(rect.position + Vector2.right * width, new Vector2(20f, rect.height)), " - ", new GUIStyle(EditorStyles.label) { alignment = TextAnchor.MiddleCenter });
