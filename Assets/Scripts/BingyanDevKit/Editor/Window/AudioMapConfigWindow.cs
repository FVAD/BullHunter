    ...
    public class AudioMapConfigWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            if (groupVisibilities == null)
            {
                ...
                for (int i = 0; i < groups.arraySize; i++)
                {
                    ...
                    groupVisibilities[i].Infos = new bool[groups.GetArrayElementAtIndex(i)
                                                                            ...
                                                                            .arraySize];
                    for (int j = 0; j < groupVisibilities[i].Infos.Length; j++) groupVisibilities[i].Infos[j] = true;
                }
            }
            ...
            for (int i = 0; i < groups.arraySize; i++)
            {
                ...
                if (!group.FindPropertyRelative("Name").stringValue.Contains(search)) continue;
