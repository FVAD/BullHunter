...
namespace Bingyan
{
    ...
    public static class Archive
    {
        ...
        /// </summary>
        private static readonly List<DataParser> parsers = new List<DataParser>();
        ...
        {
            parsers.Add(new DataParser(typeof(T), prefix, importer, exporter));
        }
        ...
        private class DataParser
        {
            ...
            private string TrimPrefix(string str) => str.Substring(str.Length);
