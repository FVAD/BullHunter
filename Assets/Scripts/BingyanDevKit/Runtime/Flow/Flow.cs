...
{/// <summary>
 ...
 /// </summary>
    public class Flow
    {
        private static readonly Stack<Flow> pool = new Stack<Flow>();

        private readonly Handle handle;
        private readonly List<Action<Handle>> actions = new List<Action<Handle>>();
        ...
        public static Flow Create() => pool.Count > 0 ? pool.Pop() : new Flow();
