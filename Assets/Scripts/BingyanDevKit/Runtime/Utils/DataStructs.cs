...
namespace Bingyan
{
    ...
    public struct IntRange
    {
        ...
        public static IntRange operator *(IntRange left, int right) => new IntRange(left.Min * right, left.Max * right);
        public static IntRange operator *(int left, IntRange right) => new IntRange(left * right.Min, left * right.Max);
        public static FloatRange operator *(IntRange left, float right) => new FloatRange(left.Min * right, left.Max * right);
        public static FloatRange operator *(float left, IntRange right) => new FloatRange(left * right.Min, left * right.Max);
    }
    ...
    public struct FloatRange
    {
        ...
        public static FloatRange operator *(FloatRange left, float right) => new FloatRange(left.Min * right, left.Max * right);
        public static FloatRange operator *(float left, FloatRange right) => new FloatRange(left * right.Min, left * right.Max);
    ...
    {
        public static readonly FloatCurve Zero = new FloatCurve() { mode = Mode.Value, value = 0 };
