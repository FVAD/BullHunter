...
namespace Bingyan
{
    ...
    public class Tween
    {
        ...
        internal static Stack<Tween> pool = new Stack<Tween>();
        ...
        public static Builder Lerp(float speed = 0.1f) => new Builder(TweenType.Lerp) { arg = speed };
        ...
        /// <returns>用于配置这个Tween的Builder对象</returns>
        public static Builder Linear(float length = 0.1f) => new Builder(TweenType.Linear) { arg = length };
        ...
        /// </summary>
        /// <returns>用于配置这个Tween的Builder对象</returns>
        public static Builder NextFrame() => new Builder(TweenType.NextFrame) { };
    ...
    {
        public static readonly TweenHandle Invalid = new TweenHandle(0);
